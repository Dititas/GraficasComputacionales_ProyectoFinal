...
LightShaderClass::LightShaderClass(char* vsFilename, char* fsFilename)
{
	nombreVs = vsFilename;
	nombrePS = fsFilename;
}
...
bool LightShaderClass::Initialize(OpenGLClass* OpenGL, HWND hwnd)
{
	...
	result = InitializeShader(nombreVs, nombrePS, OpenGL, hwnd);
	if (!result)
	{
		return false;
	}
...
bool LightShaderClass::PonMatriz4x4(OpenGLClass* OpenGL, char* nombre, float* matriz)
{
...
bool LightShaderClass::Pon1Entero(OpenGLClass* OpenGL, char* nombre, int valor)
{
	unsigned int location;
...
bool LightShaderClass::Pon1Flotante(OpenGLClass* OpenGL, char* nombre, float valor)
{
	unsigned int location;
	...
	OpenGL->glUniform1f(location, valor);
	return true;
}

bool LightShaderClass::PonVec3(OpenGLClass* OpenGL, char* nombre, float* vector)
{
	unsigned int location;
...
bool LightShaderClass::PonVec4(OpenGLClass* OpenGL, char* nombre, float* vector)
{
	unsigned int location;
