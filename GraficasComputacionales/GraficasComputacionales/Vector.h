...
public:
	...
	//esto es de Graficas Computacionales no ocupan aprenderselo para la revision
	void Transforma(Vector& v, float grados2, int eje = 0)
	{
		float Matriz[4][4];
		float grados = (float)(grados2 * 3.141516 / 180.0);
	...
	void Copia(Vector& a1, Vector a2)
	{
		a1 = a2;
	}
	...
	Vector operator ()(float Vx, float Vy, float Vz)
	{
		Vector tempo;
